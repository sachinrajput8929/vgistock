...
$sql = "INSERT INTO vgi_product_distribution (staff_name, product_name,product_code, remark, quantity, return_request, status, given_date) VALUES ('$staff_name', '$product_name','$product_code', '$remark', '$quantity', '0', '$status', '$tdate')";
