                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2 style="color: red;font-weight: 700;">Damage Product Name</h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
                                    ...
                                    <div class="col-lg-12">
                                       <div class="table-responsive-sm">
                                          ...
                                          <table class="table table-striped  table-bordered">
                                             ...
                                             <thead style="background-color:#cf0000;color: white;">
                                                <tr>
                                                   <th style="width: 2%">No</th>
                                                   <th style="width: 30%">Product Name</th>
                                                   <th style="width: 100%">Damage Product with Staff</th>
                                             ...
                                             while ($data = mysqli_fetch_array($result)) {
                                              ...
                                              <tr>
                                                  ...
                                                  <div class="col card" style="box-shadow: inset -1px 0px 3px 0px #c5c1c1;">

                                                    <div style="color: black;font-size: 20px;font-weight: 900; ">
                                                       <img src="images/logo/d.png" style="width: 80px">&nbsp;&nbsp;&nbsp;<?php echo $pname;?>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="col card">
                                                    <div>
                                                     ...
                                                     <thead>
                                                       ...
                                                       <?php
                                                   $sqlt = "SELECT product_name, SUM(return_quantity) AS total_quantity FROM vgi_product_distribution WHERE product_name = '$product_n' AND return_request = 'Damage' GROUP BY product_name";
